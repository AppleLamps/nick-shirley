    ...
    <div className="max-w-[1600px] mx-auto px-4 py-12">
      ...
      <div className="border-t-4 border-black pt-8 mb-12">
        <div className="flex items-center gap-4 mb-4">
          ...
          <h1 className="text-6xl font-bold font-headline">Live Feed</h1>
        </div>
      ...
      <div className="mt-16 p-8 bg-gray-50 border border-gray-200">
        ...
        <div className="mt-6 flex gap-6">
          <a
            ...
            className="inline-flex items-center gap-3 font-sans text-base font-bold text-black hover:underline"
          >
            Follow @nickshirleyy
